...
namespace Gvinci.Plugin.Action
{
    internal class GPluginActionAsaasPaymentsRefund : GPluginAction
    {
        ...
        {
            string code = $"var client = GvinciAsaas.Asaas_PaymentsRefund({this.Parameters[0].Value}, {this.Parameters[1].Value}, {this.Parameters[2].Value}, {this.Parameters[3].Value});";
            return code;
        }
    }
}
