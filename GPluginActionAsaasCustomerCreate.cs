    ...
    internal class GPluginActionAsaasCustomerCreate : GPluginAction
    {
        ...
        public GPluginActionAsaasCustomerCreate(IGPlugin Plugin) : base(Plugin)
        {
            ...
            _Paramiters = new List<GPluginActionParameter>()
            {
                ...
                new GPluginActionParameter() { ID =  3, Name = "Nome do cliente (Requirido)",       Type = PluginActionParameterTypeEnum.STRING },
                new GPluginActionParameter() { ID =  4, Name = "Cpf/Cnpj (Requerido)",              Type = PluginActionParameterTypeEnum.STRING },
                ...
                new GPluginActionParameter() { ID = 20, Name = "Retorno - ID do cliente (Textbox)",  Type = PluginActionParameterTypeEnum.CONTROL, AllowedControlTypes = new string[] {"GTEXTBOX"} },
                new GPluginActionParameter() { ID = 21, Name = "Retorno - Retorno da API (Textbox)", Type = PluginActionParameterTypeEnum.CONTROL, AllowedControlTypes = new string[] {"GTEXTBOX"} },
           };
        }
        ...
        public override void WriteActionCall(StringBuilder Builder, int Identation, int ActionSequence)
        {
            ...
            string Nome                     = (this.Parameters[ 2].Value.ToString() != "" ? this.Parameters[ 2].Value.ToString() : "\"\"");
            string CpfCnpj                  = (this.Parameters[ 3].Value.ToString() != "" ? this.Parameters[ 3].Value.ToString() : "\"\"");
            string Email                    = (this.Parameters[ 4].Value.ToString() != "" ? this.Parameters[ 4].Value.ToString() : "\"\"");
            string Telefone                 = (this.Parameters[ 5].Value.ToString() != "" ? this.Parameters[ 5].Value.ToString() : "\"\"");
            string Celular                  = (this.Parameters[ 6].Value.ToString() != "" ? this.Parameters[ 6].Value.ToString() : "\"\"");
            string Endereco                 = (this.Parameters[ 7].Value.ToString() != "" ? this.Parameters[ 7].Value.ToString() : "\"\"");
            string Numero                   = (this.Parameters[ 8].Value.ToString() != "" ? this.Parameters[ 8].Value.ToString() : "\"\"");
            string Complemento              = (this.Parameters[ 9].Value.ToString() != "" ? this.Parameters[ 9].Value.ToString() : "\"\"");
            string Bairro                   = (this.Parameters[10].Value.ToString() != "" ? this.Parameters[10].Value.ToString() : "\"\"");
            string Cep                      = (this.Parameters[11].Value.ToString() != "" ? this.Parameters[11].Value.ToString() : "\"\"");
            string ReferenciaExterna        = (this.Parameters[12].Value.ToString() != "" ? this.Parameters[12].Value.ToString() : "\"\"");
            string NotificacaoDesabilitada  = (this.Parameters[13].Value.ToString() != "" ? this.Parameters[13].Value.ToString() : "\"false\"");
            string EmailsAdicionais         = (this.Parameters[14].Value.ToString() != "" ? this.Parameters[14].Value.ToString() : "\"\"");
            string InscricaoMunicipal       = (this.Parameters[15].Value.ToString() != "" ? this.Parameters[15].Value.ToString() : "\"\"");
            string InscricaoEstadual        = (this.Parameters[16].Value.ToString() != "" ? this.Parameters[16].Value.ToString() : "\"\"");
            string Observacoes              = (this.Parameters[17].Value.ToString() != "" ? this.Parameters[17].Value.ToString() : "\"\"");
            string NomeGrupo                = (this.Parameters[18].Value.ToString() != "" ? this.Parameters[18].Value.ToString() : "\"\"");
            ...
            {
                Builder.AppendLine(indentStr + $"var response = GvinciAsaasCommunity.Asaas_CustomerCreate(Token: { Token }, Name: { Nome }, CpfCnpj: { CpfCnpj }, Email: { Email }, Phone: { Telefone }, Mobilephone: { Celular }, Address: { Endereco }, AddressNumber: { Numero }, Complement: { Complemento }, Province: { Bairro }, PostalCode: { Cep }, ExternalReference: { ReferenciaExterna }, NotificationDisabled: bool.Parse({ NotificacaoDesabilitada }), AdditionalEmails: { EmailsAdicionais }, MunicipalInscription: { InscricaoMunicipal }, StateInscription: { InscricaoEstadual }, Observations: { Observacoes }, GroupName: { NomeGrupo }, Environment: { Ambiente });");
