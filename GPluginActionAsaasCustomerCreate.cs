...
namespace Gvinci.Plugin.Action
{
    internal class GPluginActionAsaasCustomerCreate : GPluginAction
    {
        ...
        public GPluginActionAsaasCustomerCreate(IGPlugin Plugin) : base(Plugin)
        {
            ...
            {
                //Informações requeridas pela ação do plugin
                ...
                //Informações adicionais na ação do plugin
        ...
        {
            //Inicialização das variaveis para tratamento dos parametros recebidos na ação do plugin
            ...
            string Referencia               = (this.Parameters[12].Value.ToString() != "" ? this.Parameters[12].Value.ToString() : "\"\"");
            ...
            //Variavel que guarda a identação que sera usada na escrita da ação do plugin
            ...
            if (Token != "" && Nome != "" && CpfCnpj != "")
            {
                ...
                //Testa se foi informado um controle para receber o dado de retorno
